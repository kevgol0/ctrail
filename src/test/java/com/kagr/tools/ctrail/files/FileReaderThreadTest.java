...
public class FileReaderThreadTest
{
    ...
    public void test()
    {
        ...
        FileReaderThread frt = new FileReaderThread(files, strout, null, mgr);
        String line = "hello world, Timeout";
        assertFalse(frt.shouldExcludeLineDueToSeachTerms(line, filter));
        line = "hello world, received";
        assertTrue(frt.shouldExcludeLineDueToSeachTerms(line, filter));
    }
